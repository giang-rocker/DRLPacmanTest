...
target = open("logCNN/setting.txt", 'w')
target.write("-SETTING-\n")
target.write("OBSERVE: "+str(OBSERVE) +" REPLAY_MEMORY: "+ str(REPLAY_MEMORY) +" LEARING_RATE: " + str(LEARNING_RATE))
target.write("NUM OF FRAME: "+str(NUM_OF_FRAME) +"BATCH SIZE" + str(BATCH))
target.close()
