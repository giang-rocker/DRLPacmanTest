...
public final class Constants {
    ...
    //for Maze
    public static final String pathMazes = "/engine/data/mazes";
    public static final String pathDistances = "/engine/data/distances";
    ...
    public static String pathImages = "/engine/data/images";
